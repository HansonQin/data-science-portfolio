...
fitness_func <- function(data, response, predictors, subject,fitness_hash=NULL, fitness_function = AIC,family='gaussian',...){
...
#fields_formula(data,'y',test_chromosome)

#lm_chromosome$residuals
# fitness(data,'y',test_chromosome)
